...
class StateAbstract
{
    ...
    public function getUploadOneFields($fieldTypes): array
    {
        $uploadFields = [];
    ...
    public function getUploadMultipleFields($fieldTypes): array
    {
        $uploadFields = [];
    ...
    public function uploadOneData($fieldTypes): array
    {
        $uploadData = [];

        $uploadFields = $this->getUploadOneFields($fieldTypes);
    ...
    public function uploadMultipleData($fieldTypes): array
    {
        $uploadFields = [];
        $uploadData = [];
